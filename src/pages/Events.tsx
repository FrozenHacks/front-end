...
import MobileLayout from "../components/EventsPage/MobileView/MobileLayout";
...
const Events = () => {
  ...
  return (
    <div>
      <div className="h-fit max-sm:hidden relative flex flex-col items-center w-screen overflow-y-scroll">
        <Navbar ModalRef={ref} />
        <div className="sm:px-10 md:px-28 lg:px-40 py-28 bg-customPurple h-fit shrink-0 flex items-start w-full gap-5 px-0">
          <div className="opacity-40 -z-10 absolute inset-0 bg-black"></div>
          <FiltersComponent />
          <SearchResult />
        </div>
        {/* <Advertisement /> */}
      ...
      <div className="bg-customPurple h-fit sm:hidden flex flex-col items-center">
        <div className="my-[8vh] mx-4  overflow-y-scroll">
          <SearchResult />
        </div>
        <MobileLayout />
      </div>
